...
class AuthenticationFilter(private var authenticationManager: AuthenticationManager? = null,
    ...
    @Autowired
    private lateinit var authRequireCheckService: cn.windyrjc.security.web.AuthRequireCheckService
    @Autowired
    ...
    override fun doFilter(request: ServletRequest, response: ServletResponse, chain: FilterChain) {
        ...
        try {
            //拿到通过登录路径拿到对应的处理器
            val authenticationService: cn.windyrjc.security.web.AuthenticationService<*> = getAuthenticationService(request)
            val formClass: Class<*>
...
//            authResult as AuthenticationUser
    ...
    @Throws(WindySecurityException::class)
    private fun getAuthenticationService(request: HttpServletRequest): cn.windyrjc.security.web.AuthenticationService<*> {
        var authenticationService: cn.windyrjc.security.web.AuthenticationService<*>? = null
