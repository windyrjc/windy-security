...
class AuthenticationProcessingFilter : OncePerRequestFilter(), InitializingBean {
    ...
    private val log = LoggerFactory.getLogger(cn.windyrjc.security.web.AuthenticationProcessingFilter::class.java)
    private var eventPublisher: AuthenticationEventPublisher = cn.windyrjc.security.web.AuthenticationProcessingFilter.NullEventPublisher()
