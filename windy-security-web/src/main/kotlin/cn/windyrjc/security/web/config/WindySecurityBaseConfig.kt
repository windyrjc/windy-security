...
import cn.windyrjc.security.web.AuthenticationProcessingFilter
import cn.windyrjc.security.web.AuthenticationService
import cn.windyrjc.security.web.WindySecurityAuthenticationEntryPoint
...
//    }
    ...
    @Bean
    @ConditionalOnMissingBean
    fun authenticationProcessingFilter(): cn.windyrjc.security.web.AuthenticationProcessingFilter {
        return cn.windyrjc.security.web.AuthenticationProcessingFilter()
    }
