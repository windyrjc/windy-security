...
import cn.windyrjc.security.web.*
import cn.windyrjc.security.web.config.selector.WindySecurityConfigSelector
import cn.windyrjc.security.web.cors.SimpleCorsFilter
import cn.windyrjc.security.web.properties.WindySecurityWebProperties
import cn.windyrjc.security.web.resolver.WindySecurityWebArgumentResolver
...
class WindySecurityWebConfig : WebSecurityConfigurerAdapter(), WebMvcConfigurer {
    ...
    @Autowired
    lateinit var authenticationProcessingFilter: cn.windyrjc.security.web.AuthenticationProcessingFilter
    @Autowired
    ...
    fun authenticationFilter(): cn.windyrjc.security.web.AuthenticationFilter {
        return cn.windyrjc.security.web.AuthenticationFilter(authenticationManager(), authenticationSuccessHandler, authenticationFailureHandler)
    }

    @Bean
    @ConditionalOnMissingBean
    fun authRequireCheckService(): cn.windyrjc.security.web.AuthRequireCheckService {
        return cn.windyrjc.security.web.AuthRequireCheckService()
    }
